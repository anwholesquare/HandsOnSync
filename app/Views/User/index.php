...
<body>
    ...
    <div id="bg" style="position: fixed;height:100vh; margin:0; width: 100vw;overflow:hidden !important;z-index:-100">
        <div id='stars'></div>
        <div id='stars2'></div>
        <div id='stars3'></div>
    </div>
    ...
    <div class="container" style="margin-top: 50px;">
        ...
        <div class="row justify-content-center py-5">
            ...
            <div class="col-md-8">
                ...
                <h2 class='text-white'> My Certification </h2>
                <br>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <h6 class='text-white'> Certification Completion Rate</h6>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <h6 class='text-white'> Learnt Words</h6>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <h6 class='text-white'> Highest Score</h6>
                    </div>
                </div>

                <div class="col" style="z-index:1000;position:relative;">
                    <button class="btn btn-primary mt-3 p-3 noPrint" onclick="window.print();"> Download Profile
                    </button>
                    <a href="<?= base_url('asl/quiz') ?> "><button class="btn btn-danger mt-3 mx-3 p-3 noPrint"> Beat
                            The
                            Score
                        </button> </a>
                    <a href="<?= 'https://www.facebook.com/sharer/sharer.php?u=' . current_url() ?>"><button
                            class="btn btn-info mt-3 p-3 noPrint"> Share this link
                        </button> </a>
                </div>

                <br>

                <h2 class='text-white'> Join the Community </h2>
                <br>
                <iframe
                    ...
                    width="320" height="500" style="border:none;overflow:hidden;border-radius:10px;" scrolling="no"
